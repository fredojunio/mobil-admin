<template>
  <Admin>
    ...
    >
      <h1 class="text-2xl font-semibold text-gray-900 mr-auto">Daftar Mobil</h1>
                  ...
                  <tr v-for="item in items" :key="item.id">
                    ...
                    >
                      <div class="flex items-center">
                        <div class="font-medium text-gray-900">Toyota</div>
                      </div>
                    </td>
                    <td
                      class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6 grow"
                    >
                      <div class="flex items-center">
                        <div class="font-medium text-gray-900">Avanza</div>
                      </div>
                    </td>
                    <td
                      class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6 grow"
                    >
                      <div class="flex items-center">
                        <div class="font-medium text-gray-900">20m</div>
                      </div>
                    </td>
                    <td
                      class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6 grow"
